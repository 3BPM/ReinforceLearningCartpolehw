...
class ResultAnalyzer:
    ...
    def plot_detailed_response(self, save_path=None):
        ...
        # 1. 轮轴位置响应
        ax1 = axes[0]
        ax1.plot(times, states[:, 0], 'b', linewidth=1.5, label='轮轴位置')
        ...
        ax2.plot(times, angle_deg, 'b', linewidth=1.5, label='摆杆角度')
        ...
        # 3. 控制力
        ax3 = axes[2]
        ax3.plot(times, controls, 'g', linewidth=1.5, label='控制力')
